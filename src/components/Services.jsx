      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative flex z-1 items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <ul className="body-2">
                {brainwaveServices.map((item, index) => (
                  <li
                    key={index}
                    className="flex items-start py-4 boreder-t border-n-6"
                  >
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x1/2" />
          </div>
          <div className="relative a-1 grid gap-5 lg:grid-cols-2">
